...
liczby=[10**n for n in range(0,11)]
czasy1=[zmierz(lambda: min1(losowa_lista_liczb(n))) for n in liczby]
czasy2=[zmierz(lambda: min2(losowa_lista_liczb(n))) for n in liczby]
czasy3=[zmierz(lambda: min3(losowa_lista_liczb(n))) for n in liczby]
czasy4=[zmierz(lambda: min4(losowa_lista_liczb(n))) for n in liczby]

plt.xscale('log')
plt.scatter(liczby, czasy1, color='r')
plt.scatter(liczby, czasy2, color='y')
plt.scatter(liczby, czasy3, color='g')
plt.scatter(liczby, czasy4, color='c')
plt.show()
